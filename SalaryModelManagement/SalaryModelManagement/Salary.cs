...
namespace SalaryModelManagement
{ 
    public class Salary
    {
        private static SqlConnection ConnectionSetup()
        {
            return new SqlConnection("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=EmployeesBookTable;Integrated Security=True");
        }
        ...
        public int UpdateEmployeeSalary(SalaryUpdateModel model)
        {
            ...
            try
            {
                ...
                {
                    SalaryModeldetails displayModel = new SalaryModeldetails();
